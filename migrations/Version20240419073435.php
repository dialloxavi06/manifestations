 ...
 */
final class Version20240419073435 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE project ADD statut VARCHAR(255) DEFAULT \'En Attente\'');
        $this->addSql('ALTER TABLE project ADD type VARCHAR(255) DEFAULT \'Général\'');
    }
